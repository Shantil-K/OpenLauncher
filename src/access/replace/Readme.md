...
`keyfilters-6-23.sh` (For webos 6-23) : In webos keyfilters are used for keybinding.That script patched the hard coded home screen package id in one of the keyfilters hence it bascilly remapped your home key to launch this custom home screen.Starting webos 25(or 24?) the home screen id is no longer hard coded therefore it only work in webos 6-23.(maybe it will work in webos 24).
